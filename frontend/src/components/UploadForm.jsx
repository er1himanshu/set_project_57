          ...
          <div className="mt-8 border-t-2 border-gray-200 pt-8 animate-fade-in">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 shadow-soft">
              <h4 className="text-xl font-bold text-gray-800 mb-3 flex items-center">
                ...
                {explanation.is_fallback ? 'Similarity Analysis' : 'Attention Heatmap'}
              </h4>
              {explanation.is_fallback && (
                <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-blue-800 text-sm flex items-start">
                    ...
                    <span>Detailed attention visualization is not available for this model. Showing similarity analysis based on the original image.</span>
                  </p>
                </div>
              )}
              ...
              <div className="bg-white rounded-lg p-4 shadow-inner">
                <img 
                  ...
                  alt={explanation.is_fallback ? "Original Image" : "Attention Heatmap"}
