      ...
      <div className="p-8">
        ...
        {explanation && showExplanation && (
          <div className="mt-8 border-t-2 border-gray-200 pt-8 animate-fade-in">
            ...
            {/* Heatmap Visualization or Fallback Message */}
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 shadow-soft">
              <h4 className="text-xl font-bold text-gray-800 mb-3 flex items-center">
                ...
                {explanation.fallback_mode ? 'Explanation' : 'Attention Heatmap'}
              </h4>
              <p className="text-gray-700 mb-4 text-sm">
                {explanation.explanation}
              </p>
              {explanation.heatmap_base64 && !explanation.fallback_mode ? (
                <>
                ...
                <div className="bg-white rounded-lg p-6 shadow-inner text-center">
                  ...
                  <p className="text-gray-700 font-medium text-base">
                    Visual heatmap is not available, but the similarity analysis is complete.
                  </p>
                  <p className="text-gray-600 text-sm mt-2">
                    The CLIP model has successfully compared your image with the description.
                  </p>
                </div>
              )}
            </div>
